module.exports = function ( grunt ) {
	...
	var s3Config = {
		aws_s3: {
				dev: {
						...
						files: [
								{ expand: true, dest: '.', cwd: 'dist/', src: ['**'], action: 'upload', differential: true },
								{ dest: '/', cwd: 'dist/', action: 'delete', differential: true }
						]
				}
		},
	...
	grunt.initConfig( grunt.util._.extend( taskConfig, userConfig, s3Config ) );
